...
const fileMap = {
  'index.html': '/',
  '1.加入前的准备工作': '/加入服务器帮助/1.加入前的准备工作.html',
  '2.如何加入服务器': '/加入服务器帮助/2.如何加入服务器.html',
  '3.给服务器新玩家的部分帮助': '/加入服务器帮助/3.给服务器新玩家的部分帮助.html',
  '4.基本命令': '/加入服务器帮助/4.基本命令.html',
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      {
        text: '加入服务器',
        items: [
          { text: '1. 加入前的准备工作', link: '/加入服务器帮助/1.加入前的准备工作' },
          { text: '2. 如何加入服务器', link: '/加入服务器帮助/2.如何加入服务器' },
          { text: '3. 给服务器新玩家的部分帮助', link: '/加入服务器帮助/3.给服务器新玩家的部分帮助' },
          { text: '4. 基本命令', link: '/加入服务器帮助/4.基本命令' },
        ]
      },
      {
        text: '其他帮助',
